...
$id_wali = mysqli_insert_id($conn);
$sql1 = "INSERT INTO as_users (id_wali_kelas,userFullname,username,password,foto,id_level) values('$id_wali','$nama','$username','$password','p.jpg','3')";
 ...
 ?>
  ...
  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="alt" class="form-control" id="input" placeholder="Enter  Alamat">
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="no" class="form-control" id="input" placeholder="Enter  No Telpon">
                  </div>
                </div>
