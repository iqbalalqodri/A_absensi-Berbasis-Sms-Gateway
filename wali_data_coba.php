...
?>
      ...
      <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="wali_data.php"><i class="fa fa-users"></i> Daftar Wali Kelas</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Wali Kelas_Data</li>
      </ol>
    </section>
<br>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
              ...
              <div class="col-md-6">
                <span class="box-title"> Daftar Wali Kelas </span>
                <a class='btn btn-xs  btn-success' href="wali_tambah_coba.php"><i class ='fa fa-plus'></i> Tambah Wali Kelas </a>
              </div>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body ">
              ...
              <?php
              $sql="SELECT * FROM as_wali_kelas as g JOIN as_guru on g.id_guru=as_guru.id_guru JOIN as_kelas as k on g.id_kelas = k.id_kelas JOIN as_pelajaran on as_guru.id_pelajaran=as_pelajaran.id_pelajaran ";
                 ...
                 if (mysqli_num_rows($sql_h) > 0) {
                  $nomor = 1;
                   ...
                   foreach ($sql_h as $key => $value) {
                    ...
                    <a class='btn btn-xs btn-warning' href='wali_edit.php?id_wali_kelas=".$value['id_wali_kelas']."'><i class='fa fa-edit'></i></a>
                    <a class='btn btn-xs btn-danger' href='javascript:hapus(".$value['id_wali_kelas'].")'><i class='fa fa-trash'></i></a></td>";
                     $tbl.= "<td>".$value['nip']."</td>";
                     $tbl.= "<td>".$value['id_guru']=$value['nama_guru']."</td>";
...
<script type="text/javascript">
  ...
  function hapus(id_wali_kelas){
    if (confirm ("Yakin Ingin Mengahapus Data Ini ???")) {
      window.location.href="wali_hapus.php?id_wali_kelas=" + id_wali_kelas;
