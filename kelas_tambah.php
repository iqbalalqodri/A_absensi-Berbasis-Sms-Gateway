...
if ($_SESSION['akses'] =='2') {
 ...
 <!--        <li class=" treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="kelas_tambah.php"><i class="fa fa-plus"></i>Tambah Kelas</a></li>
          </ul>
        </li> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kelas_Tambah</li>
      </ol>
    </section>
<br>
    <!-- Main content -->
...
$error = true;
$sql="INSERT INTO as_kelas (kelas)values('$kelas')";
            ...
            <form class="form-horizontal" action="#" method="POST">
              <div class="box-body">
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="id_jurusan" class="form-control select2" style="width: 100%;" required="">
                          ...
                          // buat ambil kategori
                            ...
                            if ($hasil_s>0) {
                             echo "<option  >"."Pilihan Jurusan"."</option>";
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="kelas" class="form-control" id="input" placeholder="Enter Nama Kelas" required="">
                  </div>
                </div>
