...
<!--               <li class=" active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="jurusan_data.php"><i class="fa fa-list"></i>Daftar Jursan</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-user"></i> Jurusan</a></li>
        <li class="active">Jurusan_data</li>
      </ol>
    </section>
<br>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
              ...
              <div class="col-md-6">
                <span class="box-title"> Daftar Jurusan </span>
                <a class='btn btn-xs  btn-success' href="jurusan_tambah.php"><i class ='fa fa-plus'></i> Tambah Jurusan </a>
              </div>
            </div>
            <!-- /.box-header -->
                 ...
                 if (mysqli_num_rows($sql_h) > 0) {
                  $nomor = 1;
                   ...
                   foreach ($sql_h as $key => $value) {
                     ...
                     $tbl.= "<td>".$nomor."</td>";
                     $tbl.= "<td>
                    <a class='btn btn-xs btn-warning' href='jurusan_edit.php?id_jurusan=".$value['id_jurusan']."'><i class='fa fa-edit'></i></a>
                    <a class='btn btn-xs btn-danger' href='javascript:hapus(".$value['id_jurusan'].")'><i class='fa fa-trash'></i></a></td>";
                     $tbl.= "<td>".$value['id_jurusan']."</td>";
...
<script type="text/javascript">
          ...
          function hapus(id_jurusan){
            if (confirm('anda yakin ingin menghapus data ini ???')) {
              window.location.href="jurusan_hapus.php?id_jurusan=" +id_jurusan;
            }
          }
