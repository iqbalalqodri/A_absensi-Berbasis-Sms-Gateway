...
htmlspecialchars($foto = $_FILES['file']['name']); //Mengambil foto/url gambar pada input type="file" name="gambar"
htmlspecialchars($folder = "img/");
htmlspecialchars($pindah = move_uploaded_file($gambar, $folder.$foto)); //Memindahkan gambar ke file gambar/ yang sudah dibuat tadi
