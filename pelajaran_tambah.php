...
<!--         <li class=" treeview">
      ...
      <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pelajaran_tambah.php"><i class="fa fa-plus"></i> Tambah Pelajaran</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pelajaran_Tamabah</li>
      </ol>
    </section>
<br>
    <!-- Main content -->
...
$error=true;
$sql="INSERT INTO as_pelajaran (pelajaran)values('$pelajaran')";
            ...
            <form class="form-horizontal" action="#" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="pelajaran" class="form-control" id="input" placeholder="Enter Nama Pelajaran" required="">
                  </div>
                </div>
