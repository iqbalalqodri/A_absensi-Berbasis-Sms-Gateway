...
<!--         <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="jurusan_tambah.php"><i class="fa fa-plus"></i>Tambah Jurusan</a></li>
          </ul>
        </li> -->
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="kelas_tambah.php"><i class="fa fa-plus"></i>Tambah Kelas</a></li>
          </ul>
        </li> 
      ...
      <li class="treeview">
          <li><a href="laporan_absen_siswa.php">
            <i class="fa fa-book  "></i>
            <span>Laporan Absen Siswa</span>
          </a></li>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah_Jurusan</li>
      </ol>
    </section>
<br>
    <!-- Main content -->
...
$error = true;
$sql="INSERT INTO as_jurusan (jurusan)values('$jurusan')";
            ...
            <form class="form-horizontal" action="#" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="jurusan" class="form-control" id="input" placeholder="Enter Nama Jurusan" required="">
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="jurusan_data.php"><input type="button" name="Cencel" class="btn btn-default" value="Cencel"></a>
