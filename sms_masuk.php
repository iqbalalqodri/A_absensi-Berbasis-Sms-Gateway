...
?>
      ...
      <li class="treeview">
        ...
        <li class="active treeview">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="sms_masuk.php"><i class="fa fa-inbox"></i> Pesan Masuk </a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Sms Masuk</a></li>
      </ol>
    </section>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active" ><a href="sms_masuk.php"><i class="fa fa-inbox"></i> Pesan Masuk
                  ...
                  $nomor = 1;
                   ...
                   foreach ($sql_h as $key => $value) {
                    ...
                    $tbl.= "<td>
                     ...
                     $tbl.= "<td>".$value['SenderNumber']."</td>";
                     $tbl.= "<td>".$value['ReceivingDateTime']."</td>";
