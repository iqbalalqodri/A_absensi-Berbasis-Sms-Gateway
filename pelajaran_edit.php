  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pelajaran_Edit</li>
      </ol>
    </section>
<br>
    <!-- Main content -->
...
$Sql = "SELECT * FROM as_pelajaran where id_pelajaran = '$id_pelajaran' ";
$sql_h=mysqli_query($conn,$Sql);
$data = mysqli_fetch_assoc($sql_h);
...
$sql="UPDATE as_pelajaran SET pelajaran = '$pelajaran' where id_pelajaran ='$id_pelajaran' ";
            ...
            <form class="form-horizontal" action="#" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="pelajaran" class="form-control" id="input" value="<?php echo $data['pelajaran'] ?>" placeholder="Enter Nama Pelajaran">
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="pelajaran_data.php"><input type="button" name="Cencel" class="btn btn-default" value="Cencel"></a>
