  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Jurusan_Edit</li>
      </ol>
    </section>
<br>
    <!-- Main content -->
...
$Sql = "SELECT * FROM as_jurusan where id_jurusan = '$id_jurusan' ";
...
$error=true;
$sql="UPDATE as_jurusan SET jurusan = '$jurusan' where id_jurusan ='$id_jurusan' ";
            ...
            <form class="form-horizontal" action="#" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="jurusan" class="form-control" id="input" value="<?php echo $data['jurusan'] ?>" placeholder="Enter Nama Jurusan">
                  </div>
                </div>
