        ...
        <div class="col-xs-12">
          <div class="box">
              ...
              <div class="col-md-6">
                ...
                <a class='btn btn-xs  btn-success' href="wali_tambah.php"><i class ='fa fa-plus'></i> Tambah Wali Kelas </a>
              </div>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body ">
              ...
              <?php
              $sql="SELECT * FROM as_wali_kelas as g JOIN as_kelas as k on g.id_kelas = k.id_kelas ";
