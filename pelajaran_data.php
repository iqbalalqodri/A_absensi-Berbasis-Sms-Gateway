...
<!--         <li class=" treeview">
      ...
      <li class=" active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="pelajaran_data.php"><i class="fa fa-database"></i> Daftar Pelajaran</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-book"></i> Pelajaran</a></li>
        <li class="active">Pelajaran_data</li>
      </ol>
    </section>
<br>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
              ...
              <div class="col-md-6">
                <span class="box-title"> Daftar Pelajaran </span>
                <a class='btn btn-xs  btn-success' href="pelajaran_tambah.php"><i class ='fa fa-plus'></i> Tambah Pelajaran </a>
              </div>
              <div class="col-md-6">
                <span class="box-title"> Import Data Pelajaran </span>
                <a class='btn btn-xs  btn-success' href="import_data/data_pelajaran/form.php" target="_blank"><i class ='fa fa-plus'></i> Import Pelajaran </a>
              </div>
            </div>
                 ...
                 if (mysqli_num_rows($sql_h) > 0) {
                  $nomor = 1;
                   ...
                   foreach ($sql_h as $key => $value) {
                     ...
                     $tbl.= "<td>".$nomor."</td>";
                     $tbl.= "<td>
                    <a class='btn btn-xs btn-warning' href='pelajaran_edit.php?id_pelajaran=".$value['id_pelajaran']."'><i class='fa fa-edit'></i></a>
                    <a class='btn btn-xs btn-danger' href='javascript:hapus(".$value['id_pelajaran'].")'><i class='fa fa-trash'></i></a></td>";
...
<script type="text/javascript">
          ...
          function hapus(id_pelajaran){
            if (confirm('anda yakin ingin menghapus data ini ???')) {
              window.location.href="pelajaran_hapus.php?id_pelajaran=" +id_pelajaran;
            }
          }
